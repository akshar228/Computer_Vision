...
//            }
      ...
      void printCCproperty(ofstream& file){
            ...
            while(index < trueNumCC + 1){
                  ...
                  file<<CCproperty[index].upperLftR-1<<" "<<CCproperty[index].upperLftC-1<<endl;
                  file<<CCproperty[index].lowerRgtR-1<<" "<<CCproperty[index].lowerRgtC-1<<endl;
...
int main(int argc, char** argv){
      ...
      if(inFile.is_open()){
            if(prettyPrintFile.is_open() && labelFile.is_open() && propertyFile.is_open() ){
                  ...
                  prettyPrintFile<<"EQAry up to newLabel after pass 1: "<<endl;
                  l.printEQAry(l.newLabel, prettyPrintFile);
                  l.connectPass2(l.Connectness, l.zeroFramedAry, l.NonZeroNeighborAry);
                  l.prettyPrint(prettyPrintFile);
                  prettyPrintFile<<"EQAry up to newLabel after pass 2: "<<endl;
                  l.printEQAry(l.newLabel, prettyPrintFile);
                  ...
                  prettyPrintFile<<endl<<"EQAry up to newLabel after manageEQAry: "<<endl;
                  l.printEQAry(l.newLabel, prettyPrintFile);
                  l.connectPass3(l.EQAry, l.zeroFramedAry);
                  l.prettyPrint(prettyPrintFile);
                  prettyPrintFile<<endl<<"EQAry up to newLabel after pass3: "<<endl;
                  l.printEQAry(l.newLabel, prettyPrintFile);
